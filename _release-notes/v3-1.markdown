...
This release includes mostly bug fixing and improvements based on regular testing, and from user input during the [CLARIAH summer school](/blog/2018/10/01/Clariah-Media-Studies-Summer-School-report) and in the [Gitter forum](/documentation/forum).
...
- Collection selection and collection information (most pages in CKAN - <https://mediasuite.clariah.nl/data> include more complete information and visualizations)
