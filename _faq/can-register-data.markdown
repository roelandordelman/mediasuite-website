...
- For questions or suggestions related to the Data services of the CLARIAH Media Suite, please use our [Collections chat room in Gitter](</documentation/forum>).
...
Note: Registering your own personal datasets is not supported yet. But you can make your own "[User collections](</documentation/howtos/user-collections>)" available via your Workspace.
